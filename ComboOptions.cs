...
namespace ProxyBase
{
  public class ComboOptions : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (ComboOptions);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (ComboOptions);
    ...
    {
      if (!(this.comboname.Text != "") || !(this.comboicon.Value > new Decimal(0)) || !(this.comboslot.Value > new Decimal(0)))
        return;
    ...
    private void comboslistbox_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        this.comboslot.Value = new Decimal(0);
        this.comboicon.Value = new Decimal(0);
        this.comboname.Text = "";
      }
    }
  }
