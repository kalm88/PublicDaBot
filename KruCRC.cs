...
namespace ProxyBase
{
  public static class KruCRC
  {
    ...
    {
      return KruCRC.Calculate(buffer, 0, buffer.Length);
    }
    ...
    public static ushort Calculate(byte[] buffer, int index, int length)
    {
      ...
      for (int index1 = 0; index1 < length; ++index1)
        num = (ushort) ((uint) buffer[index + index1] ^ ((uint) (ushort) ((uint) num << 8) ^ (uint) KruCRC.crc16Table[(int) num >> 8]));
      return num;
    }
  }
}
